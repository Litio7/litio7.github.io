...
```
```terminal
/home/kali/Documents/dockerlabs/breakmyssh:-$ nmap -p- --open -sS --min-rate 5000 -vvv -n -Pn -oG nmap1 127.17.0.2
Host: 127.17.0.2 ()	Status: Up
Host: 127.17.0.2 ()	Ports: 22/open/tcp//ssh///	Ignored State: closed (65534)
```
```terminal
/home/kali/Documents/dockerlabs/breakmyssh:-$ nmap -sCV -vvv -p22 -oN nmap2 127.17.0.2
