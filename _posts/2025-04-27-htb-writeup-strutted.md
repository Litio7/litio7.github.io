...
```terminal
/home/kali/Documents/htb/machines/strutted:-$ sudo nmap -p- --open -sS --min-rate 5000 -vvv 10.10.11.59 -n -Pn -oG nmap/nmap1
...
```terminal
/home/kali/Documents/htb/machines/strutted:-$ sudo nmap -sCV -p22,80 -vvv 10.10.11.59 -oN nmap/nmap2
...
Según [GTFOBins](https://gtfobins.github.io/gtfobins/tcpdump/#sudo), tcpdump permite ejecutar un binario tras finalizar una captura, utilizando el flag `-z`. Este binario se ejecuta con el usuario especificado mediante el flag `-Z`.
